  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container" >
          <img src="img/avatar.png" style="width:100%;height: 400px;" alt="Avatar">
        ...
        <div class="w3-container">
          ...
          <p class="w3-text-teal"> <i class="fa fa-calendar fa-fw w3-margin-right"><?= $data ?></i></p>
          <hr>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Detalhes Musical</h2>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>aslap</b></h5>
